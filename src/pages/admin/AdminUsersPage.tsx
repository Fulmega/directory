...
import { Users as UsersIcon, Mail, Shield, Calendar, Edit, Trash2, Search, X, Loader2 } from 'lucide-react';
  ...
  return (
    <AdminLayout>
        ...
        <div className="bg-card rounded-lg shadow-card p-4 mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-ring dark:bg-slate-800 dark:text-slate-100 dark:border-slate-500 dark:placeholder:text-slate-400"
            />
            {searchQuery && (
              <button
      ...
      {editingUser && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-card rounded-lg p-6 max-w-md w-full mx-4">
            <h3 className="text-xl font-bold text-foreground mb-4">Editar Rol de Usuario</h3>
            <div className="mb-4">
              <p className="text-sm text-muted-foreground mb-2">Usuario: <span className="font-semibold">{editingUser.email}</span></p>
      ...
      {deletingUser && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-card rounded-lg p-6 max-w-md w-full mx-4">
            <h3 className="text-xl font-bold text-foreground mb-4">Confirmar Eliminación</h3>
            ...
            <div className="flex justify-end space-x-3">
              ...
              >
                {saving && <Loader2 className="h-4 w-4 animate-spin" />}
                <span>{saving ? 'Eliminando...' : 'Eliminar'}</span>
              </button>
            </div>
          </div>
        </div>
